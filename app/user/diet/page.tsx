        ...
        <ScrollReveal delay={0.1}>
          <div className="bg-card border border-border rounded-2xl overflow-hidden">
            ...
            <div className="p-5 sm:p-6">
              ...
              {/* Nutritional Summary */}
              <StaggerContainer className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6" staggerDelay={0.1}>
                <StaggerItem>
              ...
              {Object.keys(mealsByDay).length > 0 ? (
                <div className="space-y-5">
                  ...
                  {Object.entries(mealsByDay).map(([day, dayMeals]: [string, any], dayIndex: number) => (
                    <ScrollReveal key={day} delay={dayIndex * 0.05}>
                        ...
                        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3" staggerDelay={0.06}>
                          {dayMeals.map((meal: any) => (
                            <StaggerItem key={meal.id}>
                              <div className="p-3 sm:p-4 bg-muted/30 rounded-xl border border-border/50 hover:bg-muted/50 hover:border-border hover:shadow-md transition-all duration-300">
