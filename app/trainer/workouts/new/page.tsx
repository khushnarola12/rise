...
import WorkoutPlanForm from '@/app/admin/workouts/new/workout-plan-form';

export default async function TrainerNewWorkoutPlanPage() {
    ...
    <div className="space-y-4 sm:space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom">
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div>
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Design a new training program for your members</p>
        </div>
      </div>
